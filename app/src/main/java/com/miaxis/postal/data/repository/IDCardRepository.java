...
public class IDCardRepository {
    ...
    private IDCard makeIDCard(IDCardRecord idCardRecord) {
        ...
        String path = FileUtil.LOCAL_STOREHOUSE_PATH + File.separator + idCard.getCardNumber() + System.currentTimeMillis() + EncryptUtil.getRandomString(10) + ".jpg";
        File file = FileUtil.saveBitmap(idCardRecord.getCardBitmap(), path);
        if (file != null) {
