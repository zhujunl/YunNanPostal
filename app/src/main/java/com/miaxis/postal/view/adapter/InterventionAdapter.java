...
import com.miaxis.postal.databinding.ItemInterventionHeaderBinding;
...
public class InterventionAdapter extends BaseAdapter<Photograph, RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        switch (viewType) {
            case TYPE_HEADER:
                ItemInterventionHeaderBinding headerBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.item_intervention_header, parent, false);
    ...
    class HeaderViewHolder extends BaseViewHolder<ItemInterventionHeaderBinding> {
